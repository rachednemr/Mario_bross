  ...
  int show_menu()
    ...
    effect_menu=Mix_LoadWAV("gamemenu1.wav");
         ...
         SDL_Init(SDL_INIT_EVERYTHING);
           SDL_Surface *screen_menu,*image_menu,*mario_head,*items_menu,*items_menu2;
           screen_menu=SDL_SetVideoMode(640,480,32, SDL_SWSURFACE);
           Uint32 color =SDL_MapRGB(screen_menu->format,0xff,0xff,0xff);
           SDL_Rect rect_mario_head,rect_item_start,rect_item2_start,rect_tab_item[12],rect2_tab_item[12];
...
image=SDL_DisplayFormat(SDL_LoadBMP("chompion2.bmp"));
